...
export class AgAniadeAdmiEmpresaComponent {
  ...
  //Función que coge los datos introducidos y crea al administrador de la empresa dentro de la empresa.
        ...
        res => {
          ...
          if(this.aux.length > 0){
            ...
            this.reservasServices.AgAniadeAdmi(this.usuario, this.nombre_admi, this.empresa).subscribe(
              res => {
                //Por último nos moveremos a la página que nos muestra la lista de todos los administradores de la empresa
  ...
  //Función que nos permite volver a la página anterior, es decir, a la página que muestra la lista de administradores
  volver(){
    let ruta = '/reservas/' + this.nombre_admi + '/empresas/' + this.empresa + '/lista_administradores';
    this.router.navigate([ruta])
  }
